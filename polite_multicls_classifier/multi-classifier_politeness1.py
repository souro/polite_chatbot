...
#confusion = multilabel_confusion_matrix(labels_flat, preds_flat)
from torchmetrics import ConfusionMatrix
confusion_m=ConfusionMatrix(num_classes=10, multilabel=True)
confusion = confusion_m(predictions, true_vals)
#confusion_classes_tuples = list(zip(classes, confusion))
print('Confusion Matrix')
print(confusion)
# confusion_df = pd.DataFrame(confusion,
#                      confusion_classes_tuples,
#                      columns = ['P_2','P_7','P_0', 'P_9', 'P_5', 'P_1', 'P_8','P_6','P_4','P_3'])
# print(confusion_df)
print('\nClassification Report\n')
print(classification_report(labels_flat, preds_flat, target_names=['P_2','P_7','P_0', 'P_9', 'P_5', 'P_1', 'P_8','P_6','P_4','P_3']))
